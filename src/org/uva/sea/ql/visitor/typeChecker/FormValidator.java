 ...
 */
public class FormValidator implements IFormVisitor {
	...
	public FormValidator(TypeMapper typeMapper, List<Message> errors) {
	...
	private void checkExpr(Expr expr) {
		expr.accept(new ExpressionValidator(typeMapper, errors));
	}
