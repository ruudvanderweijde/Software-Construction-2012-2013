...
public class ExpressionValidator implements IExpressionVisitor<Boolean> {
	private final TypeMapper typeMapper;
	private final List<Message> errors;

	public ExpressionValidator(TypeMapper typeMapper, List<Message> errors) {
	...
	public static boolean check(Expr expr, TypeMapper typeMapper,
			List<Message> errs) {
		ExpressionValidator check = new ExpressionValidator(typeMapper, errs);
