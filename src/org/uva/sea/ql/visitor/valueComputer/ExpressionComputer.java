package org.uva.sea.ql.visitor.valueComputer;
...
public class ExpressionComputer implements IExpressionVisitor<Value> {
	private final ValueMapper valueMapper;
	private final List<Message> errors;

	public ExpressionComputer(ValueMapper valueMapper, List<Message> errors) {
